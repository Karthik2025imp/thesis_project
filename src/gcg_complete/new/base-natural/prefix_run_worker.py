...
FOLDER-LOCAL CONFIG: this file lives in src/gcg_complete/new/base-natural/
...
model or clobber each other's logs.
    MODEL_NAME        = 'GSAI-ML/LLaDA-8B-Base' (not instruction-tuned)
    USE_CHAT_TEMPLATE  = False (Base model was never trained on the chat
                         template; wrapping raw prompts in it would be
                         out-of-distribution)
